...
const evils = [1, 2, 2, 2, 3, 5, 10];
const score = (weights, side) => {
	return side.split(' ').reduce((sum, count, i) => sum + count * weights[i], 0);
};

function goodVsEvil(good, evil) {
	const goodScore = score(goods, good);
	const evilScore = score(evils, evil);
