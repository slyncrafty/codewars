...
Kata in this Series
    ...
    Strings, strings, strings (Hard) - this Kata
...
const assertEquals = (a, b, msg) => {
	...
	else console.error('Incorrect!', a, b, msg);
};

assertEquals([].toString(), '[]', 'Should be able to handle empty arrays');
assertEquals(
	[[[[[[]]], []]]].toString(),
	'[[[[[[]]],[]]]]',
	'Should be able to handle empty nested arrays'
);
assertEquals(
...
assertEquals(
	...
	"['foobar',[['hello']]]",
	'Should enclose strings with single quotes'
);
