...
Description:
Shamelessly stolen from Here(https://adventofcode.com/2017/day/6) :)
...
strictEqual(
	memAlloc([5, 1, 10, 0, 1, 7, 13, 14, 3, 12, 8, 10, 7, 12, 0, 600]),
	70
);
strictEqual(
	memAlloc([53, 21, 10, 0, 1, 7, 13, 14, 3, 12, 8, 10, 7, 12, 0, 60]),
	316
);
strictEqual(
	memAlloc([14, 21, 10, 0, 1, 7, 0, 14, 3, 12, 8, 10, 17, 12, 0, 19]),
	826
);
strictEqual(
	memAlloc([5, 1, 10, 0, 1, 7, 13, 14, 3, 12, 8, 10, 7, 12, 0, 6]),
	5042
);
strictEqual(
	memAlloc([17, 17, 3, 5, 1, 10, 6, 2, 0, 12, 8, 11, 16, 2, 1, 6]),
	158378
);
