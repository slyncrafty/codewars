...
assertEquals(getColumnTitle(1), 'A');
assertEquals(getColumnTitle(26), 'Z');
assertEquals(getColumnTitle(52), 'AZ');
assertEquals(getColumnTitle(53), 'BA');
assertEquals(getColumnTitle(702), 'ZZ');
