/* ========== ========== ========== ========== ========== ==========*/
// https://www.codewars.com/kata/57070eff924f343280000015
/* ========== ========== ========== ========== ========== ==========*/
/*
...
function sc(time, km) {
	...
	for (let dep = firstBus; dep <= lastBus; dep += 15) {
		if (dep + travel >= wait) {
			return format(dep + travel);
		}
	}

	// next day first bus
	return format(firstBus + travel);
}
...
const assertSimilar = (actual, expected) => {
	...
	else console.log('❌Test Failed', a, 'expected equal', b);
};
assertSimilar(sc('06:00', 1), '06:02', 'good luck!');
assertSimilar(sc('06:00', 10), '06:20', 'good luck!');
assertSimilar(sc('07:00', 10), '07:05', 'good luck!');
assertSimilar(sc('10:00', 100), '10:05', 'good luck!');
assertSimilar(sc('09:00', 100), '09:20', 'good luck!');
assertSimilar(sc('05:00', 1), '06:02', 'good luck!');
assertSimilar(sc('20:00', 1), '20:02', 'good luck!');
assertSimilar(sc('20:03', 1), '06:02', 'good luck!');
assertSimilar(sc('23:58', 420), '00:00', 'good luck!');
assertSimilar(sc('10:54', 72), '10:54', 'good luck!');
assertSimilar(sc('22:23', 244), '22:23', 'good luck!');
